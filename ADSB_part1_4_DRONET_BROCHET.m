...
gen = crc.generator(p_g); %creation du crc générator % partie encodage
...
%% Partie décodage
encoded = generate(gen, B); % j'encode mes 88 bits après la chaine de communication (jsp si B ou Sb qu'il faut encodé) 
[outdata, Error] = detect(CRC, encoded); 
